...
export const tr: Dictionary = {
  ...
  home: {
    ...
    bento: {
      ...
      title: "İhtiyacınıza özel dijital çözümler",
      titleBefore: "İhtiyacınıza özel ",
      titleAccent: "dijital çözümler",
      titleAfter: "",
      lead: "Markanızı dijitalde güçlendiren uçtan uca hizmetler.",
      coreTag: "ÇEKİRDEK",
