...
export const tr: Dictionary = {
  ...
  home: {
    ...
    kayStory: {
      eyebrow: "Maskotumuz",
      title: "KAY, sadece bir logo değil.",
      body: "KAY; SALKAY'ın dijital kimliğini taşıyan, gerçek zamanlı bir 3D karakter. Farenizi takip ediyor, sayfanızı izliyor ve markanızı ekranın diğer tarafında canlı tutuyor.",
      nowTag: "Şimdi",
      nowBody: "Baş & boyun takibi, doğal bekleme hareketi",
      nextTag: "Sırada",
      nextBody: "Göz kırpma, kulak ve kuyruk hareketleri",
      laterTag: "Gelecek",
      laterBody: "Sayfa bölümlerine (tasarım, SEO, AI) tepki verme",
    },
    homeContact: {
      eyebrow: "İletişim",
