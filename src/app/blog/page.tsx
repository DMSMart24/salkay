  ...
  return (
    <>
      ...
      <Container className="pb-24">
        <div className="rounded-[1.4rem] border border-dashed border-gold/35 bg-navy-mid px-8 py-16">
          <h2 className="font-display text-h3 text-cream">{page.emptyTitle}</h2>
